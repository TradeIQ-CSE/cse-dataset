...
Generated: 2026-05-31T05:08:20.674346+00:00
Environment: local
...
| 15 | `dailyft_business_html` | news_announcements | html | rejected | 3.60 | none | HTTP status 404 |
| 16 | `alpha_vantage_symbol_search` | ohlcv | api | rejected | 1.70 | none | requires unset API key ALPHAVANTAGE_API_KEY |
| 17 | `finnhub_exchange_symbols` | listings | api | rejected | 1.70 | none | requires unset API key FINNHUB_API_KEY |
| 18 | `tradingview_comb_browser` | ohlcv | browser | rejected | 1.20 | none | browser probes skipped by CLI |
| 19 | `investing_aspi_historical_browser` | indices | browser | rejected | 1.20 | none | browser probes skipped by CLI |
