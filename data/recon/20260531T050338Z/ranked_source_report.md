...
Generated: 2026-05-31T05:03:53.906788+00:00
Environment: local
...
| 15 | `tradingview_comb_browser` | ohlcv | browser | quarantine | 4.80 | CSE, 2026, screenshot | OHLCV candidate lacks verifiable row/report dates |
| 16 | `investing_aspi_historical_browser` | indices | browser | rejected | 4.80 | CSE, 2026, screenshot | HTTP status 403 |
| 17 | `dailyft_business_html` | news_announcements | html | rejected | 3.60 | none | HTTP status 404 |
| 18 | `alpha_vantage_symbol_search` | ohlcv | api | rejected | 1.70 | none | requires unset API key ALPHAVANTAGE_API_KEY |
| 19 | `finnhub_exchange_symbols` | listings | api | rejected | 1.70 | none | requires unset API key FINNHUB_API_KEY |
